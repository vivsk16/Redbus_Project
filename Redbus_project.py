...
df_hp = read_csv_safe(r"C:\Users\vivsk\Redbus_Project\df_hp.csv")
...
if web == "📍States and Routes":
    ...
    with col2:
        select_fare = slt.radio("Choose bus fare range", ("50-499","500-999", "1000-1999", "2000 and above"))
    ...
    def filter_bus_data(state_name, route_list):
        ...
        def get_filtered_data(bus_type, fare_range):
            try:
                ...
                if fare_range == "50-499":
                    fare_min, fare_max = 50, 499
                elif fare_range == "500-999":
                    fare_min, fare_max = 500, 999  
                elif fare_range == "1000-1999":
    ...
    elif S == "Himachal Pradesh":
        filter_bus_data("Himachal Pradesh", lists_hp)
    elif S == "Assam":
